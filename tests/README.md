...
Requires Bash, Git, Guile, and coreutils. No Bats, ShellCheck, Buildkite agent,
...
and cwd. The Btrfs mock copies fixture directories instead of making snapshots;
it accepts subvolume checks, writable snapshots, and deletion within the current test fixture.
